...
export const Route = createFileRoute("/products/original")({
  head: () => ({
    meta: [
      { title: "Dry Goods Athletic Spray Powder 5.4 oz — $19.99" },
      { name: "description", content: "Patented Dry Goods Athletic Spray Powder. 5.4 oz can. Subscribe weekly (-20%) or monthly (-15%). Free shipping over $35." },
    ],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Product",
          name: "Dry Goods Athletic Spray Powder 5.4 oz",
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-12 gap-10 md:gap-12 lg:gap-16">
          ...
          <div className="md:col-span-7 md:sticky md:top-20 md:self-start">
            <div className="bg-ice/40 aspect-[4/5] grid place-items-center relative overflow-hidden">
              <img src={canHero} alt="Dry Goods Athletic Spray Powder 5.4 oz can" className="h-[85%] w-auto" width={800} height={1200} />
          ...
          <div className="md:col-span-5 space-y-8">
            <div>
              ...
              <h1 className="font-display text-5xl lg:text-6xl font-black uppercase leading-[0.9] tracking-tighter mt-4">
                Dry Goods Athletic Spray Powder<br/>5.4 oz
              </h1>
              <p className="mt-4 font-editorial italic text-xl text-ink/80">
                The patented spray-to-powder armor. Every sport.
              </p>
            </div>
