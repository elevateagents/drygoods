...
export const Route = createFileRoute("/wholesale")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Stock Dry Goods Athletic Spray Powder. Volume tiers for gyms, teams, military, and specialty retailers. Submit a wholesale inquiry." },
    ],
  }),
  component: Wholesale,
});
