...
export const Route = createFileRoute("/privacy-policy")({
  head: () => ({
    meta: [
      { title: "Privacy Policy — Dry Goods" },
      { name: "description", content: "Privacy policy and data notice for Dry Goods and Joyce Labs, LLC." },
    ],
  }),
      ...
      <section className="bg-paper px-3 pb-14 pt-24 sm:px-6 sm:pb-20 sm:pt-32 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <div className="overflow-hidden rounded-3xl border border-ink/10 bg-white px-4 py-6 shadow-lg shadow-ink/5 sm:rounded-[2rem] sm:p-10 sm:shadow-xl lg:p-12">
            <span className="block text-[11px] font-bold uppercase tracking-[0.22em] text-sky sm:text-xs sm:tracking-[0.25em]">Privacy Policy</span>
