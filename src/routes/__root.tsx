...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dry Goods — Patented Athletic. Stay Dry. Destroy Friction." },
      ...
      { property: "og:title", content: "Dry Goods — Patented Athletic. Stay Dry. Destroy Friction." },
      ...
      { name: "twitter:title", content: "Dry Goods — Patented Athletic. Stay Dry. Destroy Friction." },
