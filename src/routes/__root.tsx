...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dry Goods — Patented Athletic Spray Powder. Stay Dry. Destroy Friction." },
      ...
      { property: "og:title", content: "Dry Goods — Patented Athletic Spray Powder. Stay Dry. Destroy Friction." },
      ...
      { name: "twitter:title", content: "Dry Goods — Patented Athletic Spray Powder. Stay Dry. Destroy Friction." },
    ...
    links: [
      ...
      { rel: "icon", type: "image/png", href: "/__l5e/assets-v1/add1e611-e23e-464d-87ff-f1b2877c4962/logo-dg.png" },
      { rel: "apple-touch-icon", href: "/__l5e/assets-v1/add1e611-e23e-464d-87ff-f1b2877c4962/logo-dg.png" },
